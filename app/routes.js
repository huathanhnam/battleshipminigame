...
//set turn cho user va cho 
   ...
   app.post('/signup', passport.authenticate('local-signup', {
        successRedirect : '/profile', // Ði?u hu?ng t?i trang hi?n th? profile
        failureRedirect : '/signup', // Tr? l?i trang dang ký n?u l?i
        failureFlash : true 
    ...
    app.get('/profile', isLoggedIn, function(req, res) {
        res.render('profile.ejs', {
            user : req.user // truy?n d?i tu?ng user cho profile.ejs d? hi?n th? lên view
        });
    });
